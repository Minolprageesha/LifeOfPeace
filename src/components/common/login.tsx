...
const Login: React.FC = () => {
    ...
    const verified = { verificationCode: "", medium: "EMAIL" };
                        ...
                        <div className="login-form-box">
                            ...
                            <form >
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="password" name="current-log-password" id="current-log-password" placeholder="Password" onChange={(e) => setUserData({ ...userData, password: e.target.value })} />
                                ...
                                <div className="form-group">
                                    <button type="button" className="edu-btn btn-medium" onClick={submitLogin}>Sign In <i className="icon-4"></i></button>
                                </div>
                            </form>
                        </div>
                    </div>
